      ...
      <div className="min-h-screen bg-gray-100">
        ...
        <section className="py-16 px-6 bg-white text-center">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-gray-700">
            At Oren, we are committed to helping companies track and improve
            their environmental impact by providing insightful metrics on carbon
            emissions, water usage, waste generation, and more. With our
            intuitive platform, you can compare performance against industry
            benchmarks and drive meaningful change.
          </p>
        </section>
          ...
          <div className="mt-8 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="p-6 bg-white rounded-lg shadow-lg border">
              ...
              <p className="mt-2 text-gray-700">
                Track yearly carbon emissions and reduce environmental
                footprint.
              </p>
            </div>
            <div className="p-6 bg-white rounded-lg shadow-lg border">
